...
const newCode = code.substring(0, insertPos) + algo10String + code.substring(insertPos);
fs.writeFileSync('src/App.tsx', newCode);
console.log("ALGO 0x0A appended to artworks array.");
