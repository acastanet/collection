...
// I need to rebuild the last element of the array correctly.
// Let's find the `ALGO 0x0A` part.
const startAlgo = code.indexOf(',\n  {\n    id: "algo-0x0a",');

const beforeAlgo = code.substring(0, startAlgo);
const afterAlgo = '\n];\n\nexport default function App() {\n' + code.substring(code.indexOf('export default function App() {\n') + 'export default function App() {\n'.length);
...
const newCode = beforeAlgo + algo10String + afterAlgo;
